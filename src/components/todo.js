...
export default function Todo(props){
    ...
    let svgBoxClass = `flex justify-center items-center rounded-full shadow-xl w-8 h-8 cursor-pointer ${complete?"bg-bravo":""}`;
